...
RETURNING id, sensor_name, sensor_type, sensor_device, user_label, user_units, should_log
`
...
SELECT id, sensor_name, sensor_type, sensor_device, user_label, user_units, should_log FROM sensors
WHERE id = ? LIMIT 1
`
